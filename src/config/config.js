...
export const leetcodeApi = "https://leetcode-stats-api.herokuapp.com/LC-guddu1cse";
export const gitHubApi = "https://api.github.com/users/guddu1cse/repos";
export const linkedin = "https://www.linkedin.com/in/guddu1cse";
...
export const instagram = `https://instagram.com/guddu1cse`;
export const email = "guddu.javadev@gmail.com";
export const contact = "8084166187";


export const aboutMe = `Hello, I’m Guddu Kumar, a software engineer who graduated in 2024
